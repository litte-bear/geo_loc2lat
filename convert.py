...
if __name__ == '__main__':
    # a,b = 116.602295,39.922325
    # c=gcj02_to_wgs84(a,b)
    # print(c)

    # # file_path = r"..\data\map-location.xlsx"
    file_path = r"百度坐标.xlsx"
    ...
    lat = df["Y"]
    #
#     lng= [114.058673,114.040453,114.224361,114.277185,114.225165,114.0234,113.918763,113.96817]
#     lat = [22.553594,22.528203,22.728197,22.729026,22.736349,22.621707,22.71302,22.765249
# ]
    for i in range(len(lng)):
        # wgs84 = gcj02_to_wgs84(lng[i],lat[i])
        # print(wgs84)
        wgs84 = bd09_to_wgs84(lng[i],lat[i])
    #
    #
